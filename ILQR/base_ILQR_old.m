function [X_out, u] = base_ILQR_old(states_out,trajectory,NILQR,z0_,var)
...
%% ILQR 
    ...
    if isempty(trajectory)==false
        ...
        Tx_current = z0_;
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        traj(3,:) = [linspace(0,var.basethT,3) var.basethT*ones(1,size(trajectory,1)/2-3)];
    end
    ...
    L2 = diag([1000 1000 1 0 0 100 10 ]); % for tpa_cfs_MMD_0902
